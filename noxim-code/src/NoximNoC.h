...
SC_MODULE(NoximNoC)
{
    ...
    sc_signal <bool> req_to_custom[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];//Custom////////////////////////////////////////////////////////
    ...
    sc_signal <bool> ack_to_custom[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];//Custom////////////////////////////////////////////////////////
    ...
    sc_signal <NoximFlit> flit_to_custom[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];//Custom//////////////////////////////////////////////////
    ...
    sc_signal <int> free_slots_to_custom[MAX_STATIC_DIM + 1][MAX_STATIC_DIM + 1];//Custom//////////////////////////////////////////////////
    ...
    sc_signal <NoximNoP_data> NoP_data_to_custom[MAX_STATIC_DIM][MAX_STATIC_DIM];//Custom//////////////////////////////////////////

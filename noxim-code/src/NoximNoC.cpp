...
/*
	    t[i][j]->req_rx[DIRECTION_CUSTOM] (req_to_custom[i][j]);  //custom
	    t[i][j]->flit_rx[DIRECTION_CUSTOM] (flit_to_custom[i][j]);//custom
	    t[i][j]->ack_rx[DIRECTION_CUSTOM] (ack_to_custom[i][j]);  //custom
*/
...
/*
	    t[i][j]->req_tx[DIRECTION_CUSTOM] (req_to_custom[i][j]);   //custom
	    t[i][j]->flit_tx[DIRECTION_CUSTOM] (flit_to_custom[i][j]); //custom
	    t[i][j]->ack_tx[DIRECTION_CUSTOM] (ack_to_custom[i][j]);   //custom
*/
...
//	    t[i][j]->free_slots[DIRECTION_CUSTOM] (free_slots_to_custom[i][j]);  //custom
...
//	    t[i][j]->free_slots_neighbor[DIRECTION_CUSTOM] (free_slots_to_custom[i][j]);  //custom
...
//	    t[i][j]->NoP_data_out[DIRECTION_CUSTOM] (NoP_data_to_custom[i][j]);//custom
...
//	    t[i][j]->NoP_data_in[DIRECTION_CUSTOM] (NoP_data_to_custom[i][j]);//custom
///*
	    //Extracting Tiles: -------------Begin---------------------------------
            if(i==0 && j==1)
            {
	    cout << "\n\n Tile #4 with coordinates[0][1] being processed";

	    t[i][j]->req_rx[DIRECTION_CUSTOM] (req_to_custom[2][1]);  //custom
	    t[i][j]->flit_rx[DIRECTION_CUSTOM] (flit_to_custom[2][1]);//custom
	    t[i][j]->ack_rx[DIRECTION_CUSTOM] (ack_to_custom[0][1]);  //custom

	    t[i][j]->req_tx[DIRECTION_CUSTOM] (req_to_custom[0][1]);   //custom
	    t[i][j]->flit_tx[DIRECTION_CUSTOM] (flit_to_custom[0][1]); //custom
	    t[i][j]->ack_tx[DIRECTION_CUSTOM] (ack_to_custom[2][1]);   //custom

	    t[i][j]->free_slots[DIRECTION_CUSTOM] (free_slots_to_custom[0][1]);  //custom
	    t[i][j]->free_slots_neighbor[DIRECTION_CUSTOM] (free_slots_to_custom[2][1]);//custom
	    t[i][j]->NoP_data_out[DIRECTION_CUSTOM] (NoP_data_to_custom[0][1]);//custom
	    t[i][j]->NoP_data_in[DIRECTION_CUSTOM] (NoP_data_to_custom[2][1]);//custo
            ...
            {
	    cout << "\n Tile #6 with coordinates[2][1] being processed \n\n";

	    t[i][j]->req_rx[DIRECTION_CUSTOM] (req_to_custom[0][1]);  //custom
	    t[i][j]->flit_rx[DIRECTION_CUSTOM] (flit_to_custom[0][1]);//custom
	    t[i][j]->ack_rx[DIRECTION_CUSTOM] (ack_to_custom[2][1]);  //custom

	    t[i][j]->req_tx[DIRECTION_CUSTOM] (req_to_custom[2][1]);   //custom
	    t[i][j]->flit_tx[DIRECTION_CUSTOM] (flit_to_custom[2][1]); //custom
	    t[i][j]->ack_tx[DIRECTION_CUSTOM] (ack_to_custom[0][1]);   //custom

	    t[i][j]->free_slots[DIRECTION_CUSTOM] (free_slots_to_custom[2][1]);//custom
	    t[i][j]->free_slots_neighbor[DIRECTION_CUSTOM] (free_slots_to_custom[0][1]);//custom
	    t[i][j]->NoP_data_out[DIRECTION_CUSTOM] (NoP_data_to_custom[2][1]);//custom
	    t[i][j]->NoP_data_in[DIRECTION_CUSTOM] (NoP_data_to_custom[0][1]);//custom
	    ...
	    t[i][j]->free_slots_neighbor[DIRECTION_CUSTOM] (free_slots_to_custom[i][j]);//custom
	    t[i][j]->NoP_data_out[DIRECTION_CUSTOM] (NoP_data_to_custom[i][j]);//custom
	    t[i][j]->NoP_data_in[DIRECTION_CUSTOM] (NoP_data_to_custom[i][j]);//custo

            }

            //Extracting Tiles: --------------End---------------------------------- 	    
//	*/
	}
    }
    ...
    for (int j = 0; j <= NoximGlobalParams::mesh_dim_y; j++) {   //////////////////////////////////
        req_to_custom[i][j] = 0;
        ack_to_custom[i][j] = 0;
        free_slots_to_custom[i][j].write(NOT_VALID);
        NoP_data_to_custom[i][j].write(tmp_NoP);
    }
    }*/
    //----------------------------------------------------------------------------------------------
